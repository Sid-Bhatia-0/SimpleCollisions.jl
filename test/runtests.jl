...
@testset "PhysicsPrimitives2D.jl" begin
    ...
    std_axes = PP2D.Axes{T}()
    i_cap = PP2D.get_x_cap(std_axes)
    j_cap = PP2D.get_y_cap(std_axes)

    theta = convert(T, π / 6)
    rotated_axes = PP2D.Axes(theta)
    ...
    @testset "Manifold generation" begin
        @testset "StdCircle vs. StdCircle" begin
            ...
            (c1, c2, (r_c1 + r_c2 - d) .* -j_cap, std_axes, PP2D.Manifold(d, PP2D.rotate_180(std_axes), (r_c1 - d / 2) .* -j_cap)),
            (c1, c2, r_c2 .* -j_cap, std_axes, PP2D.Manifold(r_c1, PP2D.rotate_180(std_axes), (r_c1 / 2) .* -j_cap)),
            (c1, c2, r_c2 .* j_cap, std_axes, PP2D.Manifold(r_c1, std_axes, (r_c1 / 2) .* j_cap)),
            (c1, c2, (r_c1 + r_c2 - d) .* j_cap, std_axes, PP2D.Manifold(d, std_axes, (r_c1 - d / 2) .* j_cap)),

            (c1, c2, (r_c1 + r_c2 - d) .* unit_45, std_axes, PP2D.Manifold(d, PP2D.Axes(-theta_45), (r_c1 - d / 2) .* unit_45)),
            (c1, c2, r_c2 .* unit_45, std_axes, PP2D.Manifold(r_c1, PP2D.Axes(-theta_45), (r_c1 / 2) .* unit_45)),
            ]
        ...
        @testset "StdRect vs. StdCircle" begin
            ...
            (r1, c1, (half_height_r1 + r_c1 - d) .* -j_cap, PP2D.Manifold(d, PP2D.rotate_180(std_axes), (half_height_r1 - d / 2) .* -j_cap)),
            (r1, c1, (half_height_r1 + d) .* -j_cap, PP2D.Manifold(r_c1 - d, PP2D.rotate_180(std_axes), (half_height_r1 - (r_c1 - d) / 2) .* -j_cap)),
            (r1, c1, (half_height_r1 - d) .* -j_cap, PP2D.Manifold(r_c1 + d, PP2D.rotate_180(std_axes), (half_height_r1 - (r_c1 + d) / 2) .* -j_cap)),
            (r1, c1, (half_height_r1 - d) .* j_cap, PP2D.Manifold(r_c1 + d, std_axes, (half_height_r1 - (r_c1 + d) / 2) .* j_cap)),
            (r1, c1, (half_height_r1 + d) .* j_cap, PP2D.Manifold(r_c1 - d, std_axes, (half_height_r1 - (r_c1 - d) / 2) .* j_cap)),
            (r1, c1, (half_height_r1 + r_c1 - d) .* j_cap, PP2D.Manifold(d, std_axes, (half_height_r1 - d / 2) .* j_cap)),
            ...
            (c1, r1, (half_height_r1 + r_c1 - d) .* -j_cap, PP2D.Manifold(d, PP2D.rotate_180(std_axes), (r_c1 - d / 2) .* -j_cap)),
            (c1, r1, (half_height_r1 + d) .* -j_cap, PP2D.Manifold(r_c1 - d, PP2D.rotate_180(std_axes), (r_c1 - (r_c1 - d) / 2) .* -j_cap)),
            (c1, r1, (half_height_r1 - d) .* -j_cap, PP2D.Manifold(r_c1 + d, PP2D.rotate_180(std_axes), (r_c1 - (r_c1 + d) / 2) .* -j_cap)),
            (c1, r1, (half_height_r1 - d) .* j_cap, PP2D.Manifold(r_c1 + d, std_axes, (r_c1 - (r_c1 + d) / 2) .* j_cap)),
            (c1, r1, (half_height_r1 + d) .* j_cap, PP2D.Manifold(r_c1 - d, std_axes, (r_c1 - (r_c1 - d) / 2) .* j_cap)),
            (c1, r1, (half_height_r1 + r_c1 - d) .* j_cap, PP2D.Manifold(d, std_axes, (r_c1 - d / 2) .* j_cap)),

            (c1, r1, top_right_r1 .+ (r_c1 - d) .* unit_45, PP2D.Manifold(d, PP2D.Axes(-theta_45), (r_c1 - d / 2) .* unit_45)),
            ]
            ...
            (r1, c1, (half_height_r1 + r_c1 - d) .* -j_cap, std_axes, PP2D.Manifold(d, PP2D.rotate_180(std_axes), (half_height_r1 - d / 2) .* -j_cap)),
            (r1, c1, (half_height_r1 + d) .* -j_cap, std_axes, PP2D.Manifold(r_c1 - d, PP2D.rotate_180(std_axes), (half_height_r1 - (r_c1 - d) / 2) .* -j_cap)),
            (r1, c1, (half_height_r1 - d) .* -j_cap, std_axes, PP2D.Manifold(r_c1 + d, PP2D.rotate_180(std_axes), (half_height_r1 - (r_c1 + d) / 2) .* -j_cap)),
            (r1, c1, (half_height_r1 - d) .* j_cap, std_axes, PP2D.Manifold(r_c1 + d, std_axes, (half_height_r1 - (r_c1 + d) / 2) .* j_cap)),
            (r1, c1, (half_height_r1 + d) .* j_cap, std_axes, PP2D.Manifold(r_c1 - d, std_axes, (half_height_r1 - (r_c1 - d) / 2) .* j_cap)),
            (r1, c1, (half_height_r1 + r_c1 - d) .* j_cap, std_axes, PP2D.Manifold(d, std_axes, (half_height_r1 - d / 2) .* j_cap)),
            ...
            (c1, r1, (half_height_r1 + r_c1 - d) .* -j_cap, std_axes, PP2D.Manifold(d, PP2D.rotate_180(std_axes), (r_c1 - d / 2) .* -j_cap)),
            (c1, r1, (half_height_r1 + d) .* -j_cap, std_axes, PP2D.Manifold(r_c1 - d, PP2D.rotate_180(std_axes), (r_c1 - (r_c1 - d) / 2) .* -j_cap)),
            (c1, r1, (half_height_r1 - d) .* -j_cap, std_axes, PP2D.Manifold(r_c1 + d, PP2D.rotate_180(std_axes), (r_c1 - (r_c1 + d) / 2) .* -j_cap)),
            (c1, r1, (half_height_r1 - d) .* j_cap, std_axes, PP2D.Manifold(r_c1 + d, std_axes, (r_c1 - (r_c1 + d) / 2) .* j_cap)),
            (c1, r1, (half_height_r1 + d) .* j_cap, std_axes, PP2D.Manifold(r_c1 - d, std_axes, (r_c1 - (r_c1 - d) / 2) .* j_cap)),
            (c1, r1, (half_height_r1 + r_c1 - d) .* j_cap, std_axes, PP2D.Manifold(d, std_axes, (r_c1 - d / 2) .* j_cap)),

            (c1, r1, top_right_r1 .+ (r_c1 - d) .* unit_45, std_axes, PP2D.Manifold(d, PP2D.Axes(-theta_45), (r_c1 - d / 2) .* unit_45)),

            # reverse check with rotated_axes
            (c1, r1, (r_c1 - d) .* unit_45 .+ PP2D.rotate(top_right_r1, rotated_axes), rotated_axes, PP2D.Manifold(d, PP2D.Axes(-theta_45), (r_c1 - d / 2) .* unit_45)),
            ]
        ...
        @testset "Rect2D vs. Rect2D" begin
            ...
            (r2, r1, (half_height_r2 + d) .* -j_cap, PP2D.Manifold(half_height_r1 - d, PP2D.rotate_180(std_axes), (half_height_r2 - (half_height_r1 - d)/2) .* -j_cap)),
            (r2, r1, (half_height_r2 - d) .* -j_cap, PP2D.Manifold(half_height_r1 + d, PP2D.rotate_180(std_axes), (half_height_r2 - (half_height_r1 + d)/2) .* -j_cap)),
            (r2, r1, d .* -j_cap, PP2D.Manifold(half_height_r2 + half_height_r1 - d, PP2D.rotate_180(std_axes), d .* -j_cap)),
            (r2, r1, d .* j_cap, PP2D.Manifold(half_height_r2 + half_height_r1 - d, std_axes, d .* j_cap)),
            ...
            (r2, r1, top_right_r2 .- d, PP2D.Manifold(half_height_r1 + d, std_axes, top_right_r2 .+ (half_width_r1 + d)/2 .* -i_cap .+ (half_height_r1 + d)/2 .* -j_cap)),
            (r2, r1, top_right_r2, PP2D.Manifold(half_height_r1, std_axes, top_right_r2 .+ (half_width_r1/2) .* -i_cap .+ (half_height_r1/2) .* -j_cap)),
            (r2, r1, top_right_r2 .+ d, PP2D.Manifold(half_height_r1 - d, std_axes, top_right_r2 .+ (half_width_r1 - d)/2 .* -i_cap .+ (half_height_r1 - d)/2 .* -j_cap)),
            ]
            ...
            manifold_list = [
            # std_axes
            (r2, r1, (half_height_r2 + half_height_r1 - d) .* -j_cap, std_axes, PP2D.Manifold(d, PP2D.rotate_180(std_axes), (half_height_r2 - d/2) .* -j_cap)),
            (r2, r1, (half_height_r2 + d) .* -j_cap, std_axes, PP2D.Manifold(half_height_r1 - d, PP2D.rotate_180(std_axes), (half_height_r2 - (half_height_r1 - d)/2) .* -j_cap)),
            (r2, r1, (half_height_r2 - d) .* -j_cap, std_axes, PP2D.Manifold(half_height_r1 + d, PP2D.rotate_180(std_axes), (half_height_r2 - (half_height_r1 + d)/2) .* -j_cap)),
            (r2, r1, d .* -j_cap, std_axes, PP2D.Manifold(half_height_r2 + half_height_r1 - d, PP2D.rotate_180(std_axes), d .* -j_cap)),
            (r2, r1, d .* j_cap, std_axes, PP2D.Manifold(half_height_r2 + half_height_r1 - d, std_axes, d .* j_cap)),
            ...
            (r2, r1, top_right_r2 .- d, std_axes, PP2D.Manifold(half_height_r1 + d, std_axes, top_right_r2 .+ (half_width_r1 + d)/2 .* -i_cap .+ (half_height_r1 + d)/2 .* -j_cap)),
            (r2, r1, top_right_r2, std_axes, PP2D.Manifold(half_height_r1, std_axes, top_right_r2 .+ (half_width_r1/2) .* -i_cap .+ (half_height_r1/2) .* -j_cap)),
            (r2, r1, top_right_r2 .+ d, std_axes, PP2D.Manifold(half_height_r1 - d, std_axes, top_right_r2 .+ (half_width_r1 - d)/2 .* -i_cap .+ (half_height_r1 - d)/2 .* -j_cap)),
